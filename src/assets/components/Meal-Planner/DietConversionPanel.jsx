...
export default function DietConversionPanel({
value,
onChange,
}) {
...
pushChange({ diet: e.target.value });
}}
style={{
width: "100%",
marginTop: "0.45rem",
...
value={mealStyle}
onChange={(e) => {
setMealStyle(e.target.value);
pushChange({ mealStyle: e.target.value });
}}
style={{
width: "100%",
marginTop: "0.45rem",
...
pushChange({ notes: e.target.value });
}}
